# -*- coding: utf-8 -*-
"""Data cleaning and ModelData assembly for Q2.

Independently copied from q1_test/algorithms/preprocess.py and re-tested
per AGENT.md section 7.  Produces the same ModelData structure with all
hard constraints (suitability, area conservation, rotation, legume, etc.)
that Q2 inherits from Q1.

Q2-specific additions:
  - template2 mapping (result2.xlsx: 7 year sheets 2024..2030)
  - crop_type classification for price evolution (粮食/蔬菜/羊肚菌/其他食用菌)
"""
